...
from models.segmentor_3class import StrokeSegmentor3Class, SEG_CLASS_NAMES
...
class StrokePipeline3Class:
    ...
    def _load_segmentor(self, ckpt_path: str) -> StrokeSegmentor3Class:
        ckpt = torch.load(ckpt_path, map_location=self.device, weights_only=True)
        cfg = ckpt.get("config", {})
    ...
    @torch.no_grad()
    def run(self, image_input) -> Pipeline3ClassResult:
    ...
    @staticmethod
    def _overlay(orig: np.ndarray, r: Pipeline3ClassResult,
