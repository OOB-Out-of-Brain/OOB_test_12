...
from data.combined_dataset_3class import build_combined_3class_dataloaders, CLASS_NAMES
...
def main():
    ...
    _, val_loader, _ = build_combined_3class_dataloaders(
    ...
    seg_ckpt = Path("./checkpoints/segmentor_3class/best_segmentor_3class.pth")
