...
if __name__ == "__main__":
    ...
    p.add_argument("--cls-ckpt", default="./checkpoints/classifier_3class/best_classifier_3class.pth")
    p.add_argument("--seg-ckpt", default="./checkpoints/segmentor_3class/best_segmentor_3class.pth")
